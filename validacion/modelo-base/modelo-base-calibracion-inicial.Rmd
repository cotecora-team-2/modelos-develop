...
```{r}
num_draw <- 3
datos_muestra <- obtener_muestra(num_draw, frac = 0.15, seed = 13)
...
ajustes_ensemble <- 
  ...
  bind_rows()
  write_rds(ajustes_ensemble, "salidas/ensemble_ajustes.rds")
} else {
  ajustes_ensemble <- read_rds("salidas/ensemble_ajustes.rds")
}
```
